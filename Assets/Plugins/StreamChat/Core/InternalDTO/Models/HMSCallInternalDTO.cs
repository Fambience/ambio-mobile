...
namespace StreamChat.Core.InternalDTO.Models
{
    ...
    internal partial class HMSCallInternalDTO
    {
        ...
        [Newtonsoft.Json.JsonProperty("room_name", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
