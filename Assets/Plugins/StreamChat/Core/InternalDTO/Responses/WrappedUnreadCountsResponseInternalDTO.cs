...
namespace StreamChat.Core.InternalDTO.Responses
{
    ...
    internal partial class WrappedUnreadCountsResponseInternalDTO
    {
        ...
        [Newtonsoft.Json.JsonProperty("total_unread_threads_count", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
