...
namespace StreamChat.Core.InternalDTO.Responses
{
    ...
    internal partial class UpdateThreadPartialResponseInternalDTO
    {
        /// <summary>
        ...
        public ThreadResponseInternalDTO Thread { get; set; } = new ThreadResponseInternalDTO();
