...
namespace StreamChat.Core.InternalDTO.Responses
{
    ...
    internal partial class GetMessageResponseInternalDTO
    {
        /// <summary>
        ...
        public MessageWithChannelResponseInternalDTO Message { get; set; } = new MessageWithChannelResponseInternalDTO();
