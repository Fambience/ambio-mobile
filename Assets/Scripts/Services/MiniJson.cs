...
public static class MiniJSON
{
    ...
    sealed class Parser : IDisposable
    {
        ...
        enum TOKEN { NONE, CURLY_OPEN, CURLY_CLOSE, SQUARE_OPEN, SQUARE_CLOSE, COMMA, COLON, STRING, NUMBER, TRUE, FALSE, NULL }
        ...
        object ParseValue()
        {
            switch (NextToken)
            {
                ...
                case TOKEN.TRUE:
                    json.Read(); json.Read(); json.Read(); json.Read(); return true;
                case TOKEN.FALSE:
                    json.Read(); json.Read(); json.Read(); json.Read(); json.Read(); return false;
                case TOKEN.NULL:
                    json.Read(); json.Read(); json.Read(); json.Read(); return null;
                default: return null;
            }
        }
        ...
        object ParseNumber()
        {
            ...
            {
                if (double.TryParse(number, System.Globalization.NumberStyles.Float, System.Globalization.CultureInfo.InvariantCulture, out var d)) return d;
            }
