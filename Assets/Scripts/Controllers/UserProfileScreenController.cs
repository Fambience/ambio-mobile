...
//
//         // Setup back button
//         backButton = root.Q<Button>("user-backButton");
//         if (backButton != null)
//         {
//             backButton.clicked += OnBackButtonClicked;
//             Debug.Log("Back button found and registered in ProfileScreenController");
//         }
//         else
//         {
//             Debug.LogWarning("Back button not found in ProfileScreenController");
//         }
//
...
//     {
//         previousScreenGameObject = screen;
//         Debug.Log($"Previous screen set for ProfileScreenController: {screen?.name}");
//     }
//
//     private void OnBackButtonClicked()
//     {
//         Debug.Log("Back button clicked in ProfileScreenController");
//
//         // Hide current screen
...
//             Debug.Log($"Returning to previous screen: {previousScreenGameObject.name}");
//         }
//         else
//         {
//             Debug.LogWarning("No previous screen set, cannot navigate back");
//         }
//     }
//
